var lizSimpleFilterLayer = function() {
    ...
    lizMap.events.on({
        ...
        var lizSimpleFilterLayerConfig = {
            ...
            fields: [ 'district_e', 'scale', 'fwuc', 'rehab_last', 'om_started', 'ds_ws_mod'],
...
//console.log('==============');
        ...
        function getSimpleFilterHome(){
            ...
            home+= '<b href="#" class="liz-sfl-show-results"><span id="liz-sfl-item-layer-total-count">' + total + '</span> Results</b>&nbsp;&nbsp;';

            // Add export link
			home+= '<br/><i><a href="#" id="liz-sfl-export">Export filter</a></i>';
			
			// Add unfilter link
            home+= '<br/><i><a href="#" id="liz-sfl-unfilter">Disable filter</a></i>';
...
//console.log(filter);
        ...
        function activateSimpleFilterTrigger(){
            ...
            // Activate export
            $('#liz-sfl-export').click(function(){
                // Export filtered feature info geometry
				lizMap.exportVectorLayer(lizSimpleFilterLayerConfig.layername, 'ODS', false); return false;
            });
